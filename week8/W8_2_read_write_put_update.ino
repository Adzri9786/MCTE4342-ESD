...
void setup() {
  ...
  int value4 =456;
  // Write the value to the EEPROM memory, but only if the new value is different from the current value
  EEPROM.update(0, value4);
  //eeprom update only accepts int, char, long anf byte data types
}
