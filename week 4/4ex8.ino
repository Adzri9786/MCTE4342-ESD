...
unsigned char *B_writer = (unsigned char* ) 0x25;
unsigned char *B_reader = (unsigned char* ) 0x23;
unsigned char *C_dir = (unsigned char* ) 0x27;
unsigned char *C_writer = (unsigned char* ) 0x28;
unsigned char *C_reader = (unsigned char* ) 0x26;
...
void setup() {
  ...
  *C_dir = 0b00100000;   //or *dir = 32 or *dir = 0x20
  *C_writer = 0b00111000;
...
void loop() {
 ...
 for (int i = 0; i < numOfBtns; i++) {
    int reading = (((*C_reader) & btns[i].binPin) != 0);
